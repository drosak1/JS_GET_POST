...
<head>
  ...
  <title>www.DLB.one -> Virtual logger GET</title>
</head>
<body>
...
<script>
    ...
    var P1_event = function () {
        let response = fetch('https://dlb.com.pl/api.php?name=Test&port=1') 
        .then(response => {
    ...
    var P2_event = function () {
        let response = fetch('https://dlb.com.pl/api.php?name=Test&port=2') 
        .then(response => {
            console.log(response.statusText);
            return response.text();
         })
    ...
    var P3_event = function () {
        let response = fetch('https://dlb.com.pl/api.php?name=Test&port=3') 
        .then(response => {
            console.log(response.statusText);
            return response.text();
         })
